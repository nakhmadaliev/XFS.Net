...
{
    public class CashInfoObject : ISTATUS
    {
        ...
        public ISTATUS UnMarshal(IntPtr pointer)
        {
            ...
            var cashunitInfo = new WFSCDMCUINFO();
            XFSUtil.PtrToStructure<WFSCDMCUINFO>(pointer, ref cashunitInfo);
        ...
        //{
        //    WFSCDMCUINFO dto = new WFSCDMCUINFO();
        ...
        //    return XFSUtil.StructureToPtr<WFSCDMCUINFO>(dto);
        //}
