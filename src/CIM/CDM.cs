...
namespace XFSNet.CDM
{
    public unsafe class CDM : XFSDeviceBase<WFSCDMSTATUS, WFSCDMCAPS>
    {
        ...
        public bool Get_WFSCDMCUINFO(out ISTATUS value)
        {
            return InnerGetInfoWithUnMarshall(CDMDefinition.WFS_INF_CDM_CASH_UNIT_INFO, IntPtr.Zero, typeof(CashInfoObject), out value);
        }
